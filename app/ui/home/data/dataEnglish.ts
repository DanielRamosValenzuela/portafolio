export const dataTextEnglish = {
  ...
  linkCV: '/CV_DR_ENGLISH_2024.pdf'
};

export const dataTypeAnimationEnglish = {
  sequenceOne: 'you can program it',
  sequenceTwo: 'you can optimize it',
  sequenceThree: 'you can implement it',
  sequenceFour: 'you can develop it',
};
